        ...
        waitForStart();
         {
            ...
            if (position == 0) {
                ...
                moveToPosition(12, 0.4);
//                strafeToPosition(-50, 0.4);
//                moveToPosition(95, 0.4);
//                strafeToPosition(40,.4);
//                moveToPosition(7, 0.4);
//                Lifty(15, 0.4);
//                sleep(3000);
//                disy(-0.4);
//                sleep(3000);
...
//            Point RightBottom = new Point(260, 160); // bottomleft corner
            ...
            for (int x = (int) LeftTop.x; x < LeftBottom.x; x++) {
                for (int y = (int) LeftTop.y; y < LeftBottom.y; y++) {
                    green += input.get(y, x)[0];
                    blue += input.get(y, x)[1];
                    red += input.get(y, x)[2];
                    total++;
                }
            }
